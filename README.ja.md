...
| 3 | [Azure Cloud Shell ガイド](materials/docs/learner/azure-cloud-shell-guide.ja.md) | Cloud Shell Bash の起動、clone、ファイル編集、SSH 鍵、証明書生成 |
| 4 | [Day 1: デプロイチェックリスト](materials/docs/learner/day-1-deployment-checklist.ja.md) | Cloud Shell での Bicep デプロイ、デプロイ後セットアップ、疎通確認、監視確認 |
...
| 8 | [トラブルシューティングランブック](materials/docs/operations/troubleshooting-runbook.ja.md) | 症状別の確認箇所と対処 |
| 9 | [クイックリファレンス](materials/docs/reference/quick-reference-card.ja.md) | リソース名、ポート、主要コマンド、KQL |
