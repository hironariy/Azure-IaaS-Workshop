...
# ==========================================================
# NGINX Configuration for Application Gateway SSL Offloading
# ==========================================================
# Application Gateway terminates SSL and sends HTTP to backend
# NGINX serves content on HTTP:80 only (no HTTPS redirect)
# Traffic flow: Client → AppGW (HTTPS) → NGINX (HTTP)
# ==========================================================
...
server {
    ...
    # Security Headers
    # Note: HSTS is handled by Application Gateway, not NGINX
