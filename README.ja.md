...
| 教材・アプリ開発者 | [ローカル開発ガイド](materials/docs/local-development-guide.ja.md) と [design/](design/) | アプリケーション、Bicep、教材を保守・拡張する |
...
| 順番 | ページ | 内容 |
|---|---|---|
| 1 | [受講者クイックスタート](materials/docs/learner-quickstart.ja.md) | 教材の読み順とワークショップ全体像 |
| 2 | [Day 0: 事前準備](materials/docs/day-0-prerequisites.ja.md) | Azure Portal、Cloud Shell、Entra ID、クォータ、GitHub リポジトリ確認 |
| 3 | [Azure Cloud Shell ガイド](materials/docs/azure-cloud-shell-guide.ja.md) | Cloud Shell Bash の起動、clone、ファイル編集、SSH 鍵、証明書生成 |
| 4 | [Day 1: デプロイチェックリスト](materials/docs/day-1-deployment-checklist.ja.md) | Cloud Shell での Bicep デプロイ、デプロイ後セットアップ、疎通確認、監視確認 |
| 5 | [監視ガイド](materials/docs/monitoring-guide.ja.md) | Azure Monitor と Log Analytics の確認 |
| 6 | [Day 2: 回復性チェックリスト](materials/docs/day-2-resiliency-checklist.ja.md) | Azure Backup、Restore、HA 検証、ASR/test failover |
| 7 | [災害復旧ガイド](materials/docs/disaster-recovery-guide.ja.md) | BCDR の背景、安全ルール、期待結果 |
| 8 | [トラブルシューティングランブック](materials/docs/troubleshooting-runbook.ja.md) | 症状別の確認箇所と対処 |
| 9 | [クイックリファレンス](materials/docs/quick-reference-card.ja.md) | リソース名、ポート、主要コマンド、KQL |
...
アプリケーションをローカルで実行・変更する場合は、[ローカル開発ガイド](materials/docs/local-development-guide.ja.md) を参照してください。これは受講者の通常デプロイ手順ではなく、教材やアプリケーションを保守する開発者向けの任意資料です。

Bicep の構造を理解したい場合は、[Bicep テクニックガイド](materials/docs/bicep-techniques-guide.ja.md) と [materials/bicep/README.md](materials/bicep/README.md) を参照してください。
