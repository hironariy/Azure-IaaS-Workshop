...
<script>
  (function () {
    ...
    var EMBEDDED_STYLE = [
      ...
      'pre,pre.highlight{background:#0d1117;color:#e6edf3;border:1px solid #30363d;border-radius:8px;padding:.9rem 1.05rem;overflow:auto;line-height:1.6;}',
      'pre code,pre.highlight code{background:transparent;color:inherit;border:0;padding:0;font-size:.92em;}',
